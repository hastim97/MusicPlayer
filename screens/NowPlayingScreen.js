            ...
            <View style={GlobalStyles.styles.container}>
                <LinearGradient colors={[Colors.primaryGradientStart, Colors.primaryGradientEnd]}
                    ...
                    <Slider value={this.props.screenProps.position}
                            ...
                            minimumValue={0}
                            minimumTrackTintColor={Colors.heading}
                            maximumTrackTintColor={Colors.blueColor}
                            thumbTintColor={Colors.heading}
                            maximumValue={100}
                    />
                    ...
                    <View style={styles.controlButton}>
                        <TouchableOpacity onPress={() => {
                            ...
                            <AntDesign name={'heart'} color={(this.state.isLiked) ? Colors.accentColor : Colors.heading } size={responsiveFontSize(3.5)}  />
                        </TouchableOpacity>

                        <TouchableOpacity onPress={this.props.screenProps.previousSong.bind(this)}>
                            <AntDesign name={'stepbackward'} color={Colors.heading } size={responsiveFontSize(3.5)}  />
                        </TouchableOpacity>


                        <TouchableOpacity style={styles.playContainer} onPress={this.props.screenProps.togglePause.bind(this)}>
                            <MaterialIcons name={(this.props.screenProps.isPaused) ? 'play-arrow' : 'pause'} color={Colors.heading } size={responsiveFontSize(4)}  />
                        </TouchableOpacity>

                        <TouchableOpacity onPress={this.props.screenProps.nextSong.bind(this)}>
                            <AntDesign name={'stepforward'} color={Colors.heading } size={responsiveFontSize(3.5)}  />
                        </TouchableOpacity>

                        <TouchableOpacity >
                            <Entypo name={'dots-three-horizontal'} color={Colors.heading } size={responsiveFontSize(3.5)}  />
                        </TouchableOpacity>
